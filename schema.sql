...
\restrict vrCBDIqUgi7WUvVTDoC12EE5rjPwaFPzExM8g4ZbCKiKPkHQBSgaZX54ml0AX1N
...
--
-- Name: pockets; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.users (
    ...
    type text DEFAULT 'REG'::text NOT NULL,
...
--
-- Name: monthly_snapshots monthly_snapshots_pocket_id_year_month_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monthly_snapshots
    ADD CONSTRAINT monthly_snapshots_pocket_id_year_month_key UNIQUE (pocket_id, year, month);


--
-- Name: pockets pockets_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_monthly_snapshots_pocket; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_monthly_snapshots_pocket ON public.monthly_snapshots USING btree (pocket_id, year, month);


--
-- Name: idx_pockets_user_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_projects_pocket_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_projects_pocket_id ON public.projects USING btree (pocket_id);
...
--
-- Name: idx_transactions_pocket_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transactions_pocket_id ON public.transactions USING btree (pocket_id);
...
--
-- Name: TABLE pockets; Type: ACL; Schema: public; Owner: postgres
--
...
\unrestrict vrCBDIqUgi7WUvVTDoC12EE5rjPwaFPzExM8g4ZbCKiKPkHQBSgaZX54ml0AX1N
